...
https://github.com/TheIanLi/agent-config-snapshot-mcp/blob/main/demo.mp4
...
| Permission hardening | Snapshot directory enforced to `700` (owner-only) since it may contain secrets like `.env` |
